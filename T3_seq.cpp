...
// Convert RGB to Grayscale using the standard formula from https://mmuratarat.github.io/2020-05-13/rgb_to_grayscale_formulas
...
int main() {
    ...
    string outputPath = "D:\\paradis\\t3_output_grayscale\\Grayscale_image_sequential.bmp";
    ...
    cout << "Total_time = " << totalTime.count() << " ms (Sequential)" << endl;
